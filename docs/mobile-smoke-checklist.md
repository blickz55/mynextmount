...
- [ ] **I.7** — Open **Filter by name or spell ID** under results; typing narrows the farm list; clear field restores full sorted list. Optional: **Search full catalog (QA)** finds a mount without an export.
